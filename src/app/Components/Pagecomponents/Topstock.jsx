      ...
      >
        <Marquee pauseOnHover={true} speed={30}>
          {stockCards.map((data, index) => (
            ...
            >
              <div className="min-w-[350px] md:min-w-[415px] w-full border-2 border-[#b5d9d774] p-8 bg-[radial-gradient(circle,rgba(11,13,15,1)_0%,rgba(35,36,37,1)_100%)] rounded-[45px] relative overflow-hidden transition-all duration-300 hover:scale-105 hover:border-[#b5d9d7] hover:shadow-[0_0_30px_rgba(181,217,215,0.3)]">
