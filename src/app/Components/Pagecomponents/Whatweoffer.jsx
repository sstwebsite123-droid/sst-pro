    ...
    return (
        ...
        <div className='mt-[10%] mb-[10%] px-4'>
            <div className="inn_container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 mb-30 gap-6">
                    {cardsData.map((card) => (
                        <div
                            key={card.id}
                            className="w-full lg:max-w-[563px] bg-[#031425] rounded-[40px] p-8 border shadow-lg"
                        >
                            <div className="w-20 h-20 mb-6 flex items-center justify-center bg-white rounded-full">
                                <Image
                                    src={card.cardicon}
